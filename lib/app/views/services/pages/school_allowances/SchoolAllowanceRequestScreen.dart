...
class SchoolAllowanceRequestScreen extends StatefulWidget {
  ...
  @override
  State<SchoolAllowanceRequestScreen> createState() =>
      _SchoolAllowanceRequestScreenState();
}

class _SchoolAllowanceRequestScreenState
    extends State<SchoolAllowanceRequestScreen> {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _controller.initial.isFalse &&
                                    _controller.selectedEduAllowanceId == ""
                                ? const Text("Select Edu Allowance",
                                    style: TextStyle(color: Colors.red))
                                : const SizedBox(),
                            SizedBox(
                                height: _controller.initial.isTrue ? 20 : 10),
                            SizedBox(
                              width: double.infinity,
                              height: 60,
                              child: DecoratedBox(
                            ...
                            TextFormField(
                              onTap: () async {
                                ...
                                _controller.startDateController.text =
                                    pickedDateDate.toString().substring(0, 10);
                                _controller.leaveDays = pickedDateDate!
                            ...
                            _controller.initial.isFalse &&
                                    _controller
                                        .requestedAmountController.text.isEmpty
                                ? const Text("Enter your requested amount",
                                    style: TextStyle(color: Colors.red))
                                : const SizedBox(),
                            SizedBox(
                                height: _controller.initial.isTrue ? 20 : 10),
