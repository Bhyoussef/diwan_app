...
List<LeaveApprovel> leaveApprovelFromJson(String str) =>
    List<LeaveApprovel>.from(
        json.decode(str).map((x) => LeaveApprovel.fromJson(x)));

String leaveApprovelToJson(List<LeaveApprovel> data) =>
...
class LeaveApprovel {
  ...
  factory LeaveApprovel.fromJson(Map<String, dynamic> json) => LeaveApprovel(
